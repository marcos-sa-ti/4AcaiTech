      ...
      <br><br><br><br>
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <form action="${pageContext.request.contextPath}/cadastrarConsole" name="formularioConsole" id="formularioConsole" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="col-md-2">
                  ...
                  <input type="hidden" id="categoriaProduto" name="categoriaProduto" value="Console"/>
                </div>
                <br><br>
          <div class="form-group row">
                  <div class="col-lg-4">
