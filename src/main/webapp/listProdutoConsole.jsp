      ...
      <div class="container">
        <div class="row">
          ...
          <div class="form-group row col-md-2">
                  <div class="col-lg-12">
                    <input onClick="location.href='cadastrarConsole.jsp';" type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" value="Adicionar Produto">
                        </div>
        </div>
