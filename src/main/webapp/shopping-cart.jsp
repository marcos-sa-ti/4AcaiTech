								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="images/Nintendo/Switch_CrashBandcootN-SaneTrilogy.jpg" alt="IMG">
										</div>
									</td>
									<td class="column-2">Jogo 1</td>
									<td class="column-3">R$ 10,00</td>
									<td class="column-4">
									...
									<td class="column-5">R$ 10,00</td>
								</tr>

								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="images/Nintendo/Switch_KirbyStarAllies.jpg" alt="IMG">
										</div>
									</td>
									<td class="column-2">Jogo 2</td>
									<td class="column-3">R$ 10,00</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
