...
<html>
    <head>
        ...
        <title> Açai Tech - Autenticação</title>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <form id="formulario_login" action="${pageContext.request.contextPath}/validarLogin" method="post">
              ...
              <div class="p-3 p-lg-5 border">
			    ...
			    <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">E-mail </label>
                    <input type="text" class="form-control" id="c_subject" name="emaildigitadopelocliente">
                  </div>
                </div>
				...
				<div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" value="Entrar">
                        </div>
                </div>
